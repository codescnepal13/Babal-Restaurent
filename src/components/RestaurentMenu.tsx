...
//   return (
//     <div className="min-h-screen bg-black text-white p-4 md:p-8 lg:p-12 relative">
//       <div className="max-w-7xl mx-auto relative">
//         {/* Header */}
//         <div className="flex justify-between items-start mb-12 md:mb-16">
//           <div>
//             <h2 className="text-3xl md:text-4xl lg:text-3xl font-great-vibes mb-2">Our Menu</h2>
//             <h1 className="text-3xl md:text-4xl lg:text-5xl font-anton text-[#E4B951]">
//               That Always Makes You Fall<br />
//               In <span className="text-3xl md:text-3xl lg:text-3xl font-great-vibes text-white">Love</span>
//             </h1>
//           </div>
//         </div>
