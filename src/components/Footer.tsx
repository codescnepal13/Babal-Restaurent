...
// const Footer: React.FC = () => {
//   return (
//     <footer className="relative text-yellow-600">
//       {/* Black background above the curve and gray below */}
//       <svg
...
//         aria-hidden="true"
//       >
//         {/* Black area above the curve */}
//         <path
//           fill="#000000"
//           d="M0,0 L1440,0 L1440,60 Q1080,30 720,30 Q360,10 0,60 Z"
//         />
//         {/* Gray area below the curve */}
//         <path
//           fill="#111827"
//           d="M0,60 Q360,10 720,30 T1440,60 L1440,120 L0,120 Z"
//         />
//       </svg>

//       {/* Glowing yellow curve line between black and gray */}
//       <div className="absolute inset-x-0 top-0 h-24 sm:h-28 md:h-32 pointer-events-none z-20">
//         <svg
//           viewBox="0 0 1440 120"
//           preserveAspectRatio="none"
//           className="absolute inset-0 w-full h-full"
...
//             stroke="rgb(251 191 36)"
//             strokeWidth="20"
//             d="M0,60 Q360,10 720,30 T1440,60"
...
//       {/* Footer content on gray background */}
...
//               <ul className="space-y-3 sm:space-y-4">
//                 <li>
//                   <a href="#" className="text-sm sm:text-base hover:text-yellow-400 transition-colors">
//                     About us
//                   </a>
//                 </li>
//                 <li>
...
//                   href="#" 
//                   aria-label="Facebook" 
//                   className="hover:text-yellow-400 transition-all hover:scale-110 transform duration-200"
//                 >
//                   <Facebook size={24} className="sm:w-7 sm:h-7" />
//                 </a>
//                 <a 
