  ...
  />
      ...
      <div className="absolute top-32 left-0 w-full flex justify-center z-10">
        <h1 className="text-5xl md:text-6xl tracking-wide text-[#E4B951]">
          <span className="font-great-vibes text-[#E4B951] inline-block rotate-[-20deg]">About us</span> 
          <span className="block ml-20 font-bold">Babal Restaurent</span>
          {/* <span className="block ml-150 text-white font-great-vibes inline-block rotate-[-290deg]">🍴</span> */}
        </h1>
      </div>
