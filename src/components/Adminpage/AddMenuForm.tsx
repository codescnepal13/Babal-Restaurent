          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                {/* Category Dropdown */}
                <div>
                  <label className="block text-zinc-700 font-semibold mb-2">Choose Category</label>
                  <select
              ...
              {/* Image Upload */}
              <div>
                <label className="block text-zinc-700 font-semibold mb-2">Upload Images</label>
                <div className="flex items-start space-x-4">
                  <div className="flex-1">
                    <p className="text-sm text-zinc-600 mb-2">Please upload images, size less than 5MB each</p>
