...
//   return (
//     <div className="min-h-screen bg-black text-white flex items-center justify-center pb-20 px-4 py-8">
    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:py-20">
      <div className="w-full max-w-4xl">
        <div className="text-center mb-6 sm:mb-8">
          <p className="text-base sm:text-lg md:text-2xl lg:text-3xl mb-3 sm:mb-4 font-great-vibes text-gray-300">
            Reserve Now
          </p>
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div>
              ...
              <input
                ...
                placeholder="Full Name"
                required
                className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-600"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div>
              <label className="block text-xs sm:text-sm mb-2 text-[#E4B951]">Time</label>
              <div className="flex gap-2">
                <input
                  type="date"
                  name="date"
                  ...
                  onChange={handleChange}
                  required
                  className="flex-1 px-2 sm:px-4 py-2.5 sm:py-3 text-xs sm:text-base rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#E4B951]"
                />
                <input
                  type="time"
                  name="time"
                  ...
                  onChange={handleChange}
                  required
                  className="w-20 sm:w-24 px-2 sm:px-3 py-2.5 sm:py-3 text-xs sm:text-base rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#E4B951]"
                />
                <select
                  name="period"
                  value={formData.period}
                  onChange={(e) => setFormData({ ...formData, period: e.target.value })}
                  className="w-16 sm:w-20 px-2 sm:px-3 py-2.5 sm:py-3 text-xs sm:text-base rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#E4B951]"
                >
                  <option value="AM">AM</option>
                  <option value="PM">PM</option>
                </select>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Short Message"
              rows={6}
              className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-600 resize-none"
            />
          </div>
          ...
          <div className="flex justify-center pt-2">
            <button
              type="button"
              onClick={handleSubmit}
              className="w-full sm:w-auto px-12 sm:px-20 md:px-32 py-3 sm:py-3.5 bg-[#E4B951] hover:bg-yellow-700 text-white text-sm sm:text-base font-semibold rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#E4B951] focus:ring-offset-2 focus:ring-offset-black"
            >
              Submit
            </button>
          </div>
